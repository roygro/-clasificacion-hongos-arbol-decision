# ============================================================
# CLASIFICACIÓN DE HONGOS CON ÁRBOL DE DECISIÓN
# Comestible vs. Venenoso
# ============================================================
# Dataset: PROPIO (creación propia, generado con
# generar_dataset_hongos.py) - 1,800 registros | 18 variables
# predictoras | 1 variable objetivo ('clase')
# Repositorio: https://github.com/roygro/-clasificacion-hongos-arbol-decision
# ============================================================
